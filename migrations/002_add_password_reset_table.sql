-- Migration: Password reset tokens for forgot-password flow
-- Run: PGPASSWORD=dev123 psql -d davidlong_tech -U dev_user -h localhost -f migrations/002_add_password_reset_table.sql
